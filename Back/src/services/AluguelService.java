...
public class AluguelService {
        ...
        public void cadastrarAluguel(Integer mensalidadeID, Integer mesReferencia, LocalDate dataEmissao,
                                     LocalDate dataVencimento, double taxas, String codigoBarras,
                                     LocalDate dataPagamento)  {
            ValidarModel.ALUGUEL_PAGAMENTOS( mensalidadeID, mesReferencia, dataEmissao, dataVencimento,
                    taxas, codigoBarras, dataPagamento);
            aluguelRepository.adicionar(new Aluguel(mensalidadeID, mesReferencia, dataEmissao, dataVencimento,
                    taxas, codigoBarras, dataPagamento));
        }
